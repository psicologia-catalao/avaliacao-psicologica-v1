...
let app, auth, db;
if (firebaseConfig.apiKey && firebaseConfig.apiKey !== "AIzaSyXXXXXXXXXXXXXXXXXXXXXXXXXXX") {
...
export default function App() {
    ...
    return (
        <div className="bg-gray-100 min-h-screen font-sans text-gray-800" style={{'--primary-color': '#82b3cc'}}>
            {page !== 'auth' && <Header user={user} setPage={setPage} />}
        ...
        <header className="bg-white shadow-md">
            <nav className="container mx-auto px-6 py-3 flex justify-between items-center">
                ...
                <div className="flex items-center space-x-2 md:space-x-4">
                    ...
                    <button onClick={handleSignOut} className="bg-[--primary-color] text-white py-2 px-4 rounded-md hover:opacity-90 transition">Sair</button>
                </div>
            </nav>
        </header>
    );
...
const InstrumentRenderer = ({ instrumentKey, user, setPage }) => {
    ...
    switch (instrumentKey) {
        ...
        case 'whoqol':
            ...
            options = [ { text: "Nível 1", value: 1 }, { text: "Nível 2", value: 2 }, { text: "Nível 3", value: 3 }, { text: "Nível 4", value: 4 }, { text: "Nível 5", value: 5 } ];
            ...
            scoreFunction = (res) => { return { rawResponses: res }; };
            break;
        default: return null;
    }
